...
exports.render = function(id, options, userFile) {
  ...
  function getWeather(options, location, apiKey) {
    // puts all options into a query string
    var locUrl = 'http://api.openweathermap.org/data/2.5/weather?lat='
      + location.lat + '&lon=' + location.long + '&units=' + options.units + '&appid=' + apiKey;
  ...
  function updateWeather() {
    widgetLoc.innerHTML = getWeather(options, location, apiKey);
  }
